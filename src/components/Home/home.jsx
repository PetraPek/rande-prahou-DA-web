        ...
        <div className="content">
          <div className="description">
            ...
            <p className="description__introduction">
              Překvapte svoji drahou polovičku a vyražte na námi doporučená
              místa. Nikdo nemusí vědět, že jsme vám pomohli právě my. My to na
              vás neřekneme.
            </p>
            <br />
            ...
            <div className="figma">
              <img
                className="figma_logo"
                src={figma_logo_web}
                alt="figma_logo_web"
              />
              <img
                className="figma_secondpage"
